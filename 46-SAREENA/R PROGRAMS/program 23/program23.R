#In order run this program, gmodels package is required which is 
#downloaded from the install packages in the packages drop down menu
#Loads class package containing knn()
library(class)
